...
--
-- Host: localhost:3306
-- Generation Time: 02 Feb 2019 pada 14.16
...
(1, 'admin', '$2y$10$ZjPD88Ptdsi6BEroYtvu2O7HlRy1gYnURz6V7U3AJVO.1p8xACV56', '2019-01-30 10:46:29', NULL),
(2, 'ardi', '$2y$10$Q7Pia7w8L9enm1VIu1uw/ecXz7WC9jR1T2hTEURtvoL9VIUiyKb1W', '2019-01-30 11:29:37', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `backup_db_detail_pesanan`
--

CREATE TABLE `backup_db_detail_pesanan` (
...
--
-- Dumping data untuk tabel `backup_db_detail_pesanan`
--

INSERT INTO `backup_db_detail_pesanan` (`id_detail_pesanan`, `id_pesanan`, `id_produk`, `jumlah_produk`, `total_harga`, `create_at`) VALUES
(1, 3, 5, 4, 3000, '2019-01-31 09:48:30'),
(2, 3, 14, 5, 5000, '2019-01-31 09:49:08');
...
CREATE TABLE `detail_pesanan` (
  `id_detail_pesanan` varchar(13) NOT NULL,
  `id_pesanan` varchar(13) NOT NULL,
...
INSERT INTO `detail_pesanan` (`id_detail_pesanan`, `id_pesanan`, `nama_produk`, `jumlah_produk`, `total_harga`, `created_at`) VALUES
('DTL1902020001', 'PSN1902020001', 's', 4, 0, '2019-02-01 17:59:50'),
('DTL1902020002', 'PSN1902020001', 'f', 5, 0, '2019-02-01 17:59:50'),
('DTL1902020003', 'PSN1902020001', 'a', 4, 0, '2019-02-01 18:03:19'),
('DTL1902020004', 'PSN1902020001', 'b', 4, 0, '2019-02-01 18:03:19'),
('DTL1902020005', 'PSN1902020002', 'aier', 5, 1500000, '2019-02-02 05:08:01'),
('DTL1902020006', 'PSN1902020002', 'api', 6, 1800000, '2019-02-02 05:08:01'),
('DTL1902020007', 'PSN1902020003', 'makan', 2, 600000, '2019-02-02 05:08:59'),
('DTL1902020008', 'PSN1902020003', 'minum', 6, 1800000, '2019-02-02 05:08:59'),
('DTL1902020009', 'PSN1902020003', 'mandi', 3, 900000, '2019-02-02 05:08:59');
...
INSERT INTO `pesanan` (`id_pesanan`, `username`, `phone`, `alamat`, `id_kec`, `id_kab`, `id_prov`, `jasa_pengiriman`, `ongkir`, `status`, `created_at`, `updated_at`) VALUES
('1', 'admin', '0', '', '0', '0', '0', '', 0, '0', '2019-01-27 06:14:50', NULL),
('PSN1902020001', 'pp', '7', 'a', '520706', '5207', '52', 'JNE', 0, '0', '2019-02-01 18:03:19', NULL),
('PSN1902020002', 'coba', '0832473343462', 'aaa', '367110', '3671', '36', 'JNE', 0, '0', '2019-02-02 05:08:01', NULL),
('PSN1902020003', 'cobalagi', '54354235', 'sad', '360218', '3602', '36', 'JNE', 0, '0', '2019-02-02 05:08:59', NULL);
...
INSERT INTO `produk` (`id_produk`, `nama_produk`, `deskripsi_produk`, `jenis_produk`, `harga_produk`, `jumlah_produk`, `foto_produk`, `created_at`, `updated_at`) VALUES
(5, 'coba3', 'coba', 'White Acne', 123, 0, 'img21.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(10, 'sss', 'sss', 'sss', 123, 0, 'profile4.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(12, 'xxx', 'xxx', 'xxx', 232, 0, 'img2.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(13, 'tt', 'tt', 'tt', 234, 0, 'employee1.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(14, 'gg', 'gg', 'gg', 11, 0, 'img12.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(17, 'ttt', 'ttt', 'ttt', 50000, 0, '5c4b25ad7fcf8.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(18, 'yyy', 'yyy', 'yy', 50000, 0, '5c4b25d5a6364.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(19, 'fff', 'ffff', 'ffff', 50000, 0, '5c4b277ca0ae1.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(20, 'gg', 'gg', 'gg', 50000, 0, '5c4b2795f115e.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(21, 'yy', 'yy', 'yy', 50000, 0, '5c4b2815a7b44.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(22, 'q', 'q', 'q', 50000, 0, '5c4b2a33a51f8.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(23, 'krim', 'krim', 'krim', 50000, 0, '5c4b3333e7a9b.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(31, 'we', 'we', 'we', 323232, 0, '5c4b506c3b7b2.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(33, 'krim', 'ss', 'ss', 6533333, 0, '5c4c7df21354b.png', '2019-01-26 15:41:50', '2019-01-26 15:41:50'),
(34, 'Facial Wash Acne (100ml)', 'Merupakan Salah Satu Produk Claire Skin ', 'Acne', 300000, 20, '5c4d42eb51ed2.png', '2019-01-27 05:33:53', NULL);
...
--
-- Indexes for table `backup_db_detail_pesanan`
--
ALTER TABLE `backup_db_detail_pesanan`
...
--
-- AUTO_INCREMENT for table `backup_db_detail_pesanan`
--
ALTER TABLE `backup_db_detail_pesanan`
  MODIFY `id_detail_pesanan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
