...
--
-- Host: localhost:3306
-- Generation Time: 30 Jan 2019 pada 23.22
...
INSERT INTO `pesanan` (`id_pesanan`, `username`, `phone`, `alamat`, `id_kec`, `id_kab`, `id_prov`, `id_detail_pesanan`, `jasa_pengiriman`, `ongkir`, `status`, `created_at`, `updated_at`) VALUES
(1, 'admin', '0', '', '0', '0', '0', 0, '', 0, '0', '2019-01-27 06:14:50', NULL),
(3, 'coba', '0832473343462', 'coba', '340212', '3402', '34', 34, 'JNE', 0, '', '2019-01-27 14:49:38', NULL),
(5, 'Ardi', '09439740302', 'Dusun Macanan', '330808', '3308', '33', 34, 'JNE', 0, '', '2019-01-29 15:05:35', NULL),
(6, 'Amrul', '5435346', 'ffff', '351616', '3516', '35', 1, 'JNE', 0, '0', '2019-01-29 15:07:05', NULL);
...
ALTER TABLE `pesanan`
  ...
  ADD KEY `id_kab` (`id_kab`),
  ADD KEY `id_prov` (`id_prov`),
  ADD KEY `id_produk` (`id_detail_pesanan`),
